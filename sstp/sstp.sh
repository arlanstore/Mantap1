...
# Link Hosting Kalian
akbarvpn="raw.githubusercontent.com/arlanstore/Mantap/main/sstp"
...
#input perintah sstp
wget -O /usr/bin/addsstp https://${arlanstore}/addsstp.sh && chmod +x /usr/bin/addsstp
wget -O /usr/bin/delsstp https://${arlanstore}/delsstp.sh && chmod +x /usr/bin/delsstp
wget -O /usr/bin/ceksstp https://${arlanstore}/ceksstp.sh && chmod +x /usr/bin/ceksstp
wget -O /usr/bin/renewsstp https://${arlanstore}/renewsstp.sh && chmod +x /usr/bin/renewsstp
rm -f /root/sstp.sh
