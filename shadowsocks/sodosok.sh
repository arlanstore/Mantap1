...
# Link Hosting Kalian
akbarvpn="raw.githubusercontent.com/arlanstore/Mantap/main/shadowsocks"
...
cd /usr/bin
wget -O addss "https://${arlanstore}/addss.sh"
wget -O delss "https://${arlanstore}/delss.sh"
wget -O cekss "https://${arlanstore}/cekss.sh"
wget -O renewss "https://${arlanstore}/renewss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x renewss
