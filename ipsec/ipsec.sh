...
# ==================================================
# Link Hosting Kalian
akbarvpn="raw.githubusercontent.com/arlanstore/Mantap/main/ipsec"
...
wget -O /usr/bin/dell2tp https://${arlanstore}/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp https://${arlanstore}/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://${arlanstore}/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/renewpptp https://${arlanstore}/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://${arlanstore}/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
