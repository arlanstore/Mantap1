...
# ==================================================
# Link Hosting Kalian
kzero-comeback="raw.githubusercontent.com/arlanstore/Mantap/main/wireguard"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/arlanstore/Mantap/main/wireguard/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/arlanstore/Mantap/main/wireguard/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/kzero-comeback/Mantap/main/wireguard/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
